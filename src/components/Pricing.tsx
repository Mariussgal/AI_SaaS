    ...
    <div className="min-h-screen bg-[#0F0F1A] text-white bg-grid-pattern">
      ...
      <section className="px-4 max-w-6xl mx-auto mb-24">
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div 
            className="relative overflow-hidden bg-[#1A1A2E] border border-gray-800 rounded-2xl p-8 transition-all duration-300 hover:transform hover:translate-y-[-4px] hover:shadow-xl"
          >
            ...
            <p className="mt-2 text-gray-400">Perfect for individuals and small teams getting started with AI</p>
            ...
            <button
              ...
              disabled={isLoading}
              className="mt-10 w-full py-4 rounded-xl font-medium text-center transition-all bg-white text-[#0F0F1A] hover:bg-gray-200"
            >
          ...
          {/* Annual plan */}
          <div 
            className="relative overflow-hidden bg-[#1A1A2E] border border-indigo-500/50 ring-2 ring-indigo-500/20 rounded-2xl p-8 transition-all duration-300 hover:transform hover:translate-y-[-4px] hover:shadow-xl"
          >
            ...
            <button
              ...
              disabled={isLoading}
              className="mt-10 w-full py-4 rounded-xl font-medium text-center transition-all bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white"
            >
              {isLoading ? 'Processing...' : 'Get Started'}
            </button>
          </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-800">
                ...
                <th className="py-4 px-6 text-center font-medium text-lg">Monthly Plan</th>
                <th className="py-4 px-6 text-center font-medium text-lg">Annual Plan</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-gray-800/50">
                <td className="py-4 px-6">AI Agents</td>
                <td className="py-4 px-6 text-center">5 Specialized Agents</td>
                <td className="py-4 px-6 text-center">5 Specialized Agents</td>
              </tr>
              <tr className="border-b border-gray-800/50">
                <td className="py-4 px-6">Daily Requests</td>
                <td className="py-4 px-6 text-center">200 requests</td>
                <td className="py-4 px-6 text-center">200 requests</td>
              </tr>
              <tr className="border-b border-gray-800/50">
              ...
              <tr className="border-b border-gray-800/50">
                <td className="py-4 px-6">User Accounts</td>
                <td className="py-4 px-6 text-center">1</td>
                <td className="py-4 px-6 text-center">1</td>
              </tr>
              <tr className="border-b border-gray-800/50">
                <td className="py-4 px-6">Price</td>
                <td className="py-4 px-6 text-center">$19/month</td>
                <td className="py-4 px-6 text-center text-green-400">$15.83/month (billed annually)</td>
              </tr>
              <tr>
                <td className="py-4 px-6">Billing</td>
                <td className="py-4 px-6 text-center">Monthly</td>
                <td className="py-4 px-6 text-center">Annual ($190/year)</td>
              </tr>
            </tbody>
          </table>
        </div>
